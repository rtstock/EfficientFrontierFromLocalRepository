    ...
    def randomweightseries(self, 
        ...
        while 1:
            ...
            for alpha in fractions_series.index:
                if fractions_series[alpha] > self.SymbolsList[alpha][0]:
                    #print 'no good'
                    testfail = True
                    #print fractions_series[alpha]
                if fractions_series[alpha] < self.SymbolsList[alpha][1]:
                    #print 'no good'
                    testfail = True
                    #print fractions_series[alpha]
                #print alpha
...
#                ,  source='Yahoo') 
    ...
    mylist = {'a':[0.5,0.05],'b':[0.5,0.4],'c':[0.5,0.1],'d':[0.5,0.1]}
    
    o = go(mySymbolsList=mylist)
